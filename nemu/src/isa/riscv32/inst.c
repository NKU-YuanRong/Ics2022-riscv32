...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  // INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulhu   , R, R(dest) = (int32_t)(((long long)(int32_t)src1 * (long long)(int32_t)src2) >> 32));
  // // INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulhu   , R, R(dest) = (int32_t)((SEXT((long long)src1, 32) * SEXT((long long)src2, 32)) >> 32));
